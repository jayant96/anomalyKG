def params(dataset):
    ...
    # UMLS Dataset
        params.feature_file = "../results/features_selected_links.csv"
        params.svm_output_pkl = "../results/umls_svm_output.pkl"
        params.initial_attribute_count = 3  # Adjust if there are additional non-feature columns
        params.name = "UMLS"
        params.support_file = "../results/umls_support.csv"
        params.tile_plot_file_name = "../results/tile_plot_umls.eps"
        params.association_plot_file_name = "../results/association_plot_umls.eps"
        params.columns_start_count = 3  # Adjust based on feature columns
        params.ds = 100
